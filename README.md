...
|------|-------|-------------|
| [`gh_languages.txt`](data/gh_languages.txt) | 806 | Languages known to GitHub |
| [`gh_extensions.txt`](data/gh_extensions.txt) | 1450 | Language extensions known to GitHub |
| [`gh_aliases.txt`](data/gh_aliases.txt) | 415 | Language aliases known to GitHub |
...
| File | Count | Description |
|------|-------|-------------|
| [`languages.json`](data/languages.json) / [`csv`](data/languages.csv) | 806 | All languages |
...
| File | Count | Description |
|------|-------|-------------|
| [`languages_programming.json`](data/languages_programming.json) / [`csv`](data/languages_programming.csv) | 540 | Programming languages |
